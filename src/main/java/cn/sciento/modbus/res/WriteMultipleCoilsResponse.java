 ...
 * </pre>
 */
public class WriteMultipleCoilsResponse implements ModbusResponse {
	...
	public WriteMultipleCoilsResponse(int deviceId, int address, int num, int length, byte[] values) {
